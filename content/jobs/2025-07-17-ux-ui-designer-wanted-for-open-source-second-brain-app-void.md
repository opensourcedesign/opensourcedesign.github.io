...
tags: [open source, ui, ux, tauri, vue, rust, markdown, second-brain, design system, plugin-architecture, self-hosted, local-first, obsidian, notion, codemirror, theming]
