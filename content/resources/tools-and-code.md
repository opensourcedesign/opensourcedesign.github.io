...
description: "What Open Source projects use for work and coordination"
layout: resource-page
weight: 70
---

There are basic tools that most projects use. It is helpful to be
...
you are likely to know them already. This article is about the tools that developers use.


## Issue trackers

An issue tracker allows to register problems with the software and
...
software, including usability problems and feature requests.

It is helpful to first read some existing issues to understand how the
issue tracker is used and what tone of communication is typical. Don't
...
Just knowing how to program in general is helpful to follow some
...
particular parts of the code and then slowly expanding.


## Git

Open source programs are created in one or several programming
...
one used most widely is git.

Even if you do not code, you might get in contact with git, since git is
...
despite it being a tool made to manage source code -- so it more or less
...
the ideas of *commiting* changes and then *pushing* them to a central
...
Gitea is helpful for beginners.


## Mailing lists

Particularly older projects use mailing lists instead of web forums for
...
and to post you need to "subscribe" to the list. Before you post, read
along for a bit to see if the mailinglist is right for you and to know
what tone is common on it.
