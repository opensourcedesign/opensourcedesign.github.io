...
This code of conduct especially pertains to our online community platforms (GitHub: [@opensourcedesign](https://github.com/opensourcedesign), Mastodon: [@opensourcedesign](https://fosstodon.org/@opensourcedesign), Discourse Forum: [discourse.opensourcedesign.net](https://discourse.opensourcedesign.net)) as well as our offline events like the FOSDEM Open Source Design room, the FOSSASIA Design track, the Open Source Design Summit and local meetups. But it also pertains to your personal public communications and views.
